...
laserTypes = {
	"D": {
		...
		"typical pulse duration": (0.2 * uReg.s, inf),
		"count": 1,
	},
	"I": {
		"desc": "Pulsed",
		"typical pulse duration": (1e-6 * uReg.s, 0.2 * uReg.s),
		"count": 100,
	},
	"R": {
		"desc": "Giant-pulsed",
		"typical pulse duration": (1e-9 * uReg.s, 1e-6 * uReg.s),
		"count": 100,
	},
	"M": {
		"desc": "Mode-coupled",
		"typical pulse duration": (0 * uReg.s, 1e-9 * uReg.s),
		"count": 100,
	},
}
...
# nm
EN207 = {
	(180 * uReg.nm, 315 * uReg.nm): {
		"D": 1e-3 * Wm2,
		"IR": 3e1 * Jm2,
		"M": 3e10 * Jm2,
	},
	(315 * uReg.nm, 1400 * uReg.nm): {
		"D": 1e1 * Wm2,
		"IR": 5e-3 * Jm2,
		"M": 1.5e-4 * Jm2,
	},
	(1400 * uReg.nm, 1000000 * uReg.nm): {
		"D": 1e3 * Wm2,
		"IR": 1e-4 * Jm2,
		"M": 1e11 * Jm2,
	},
...
def computeGoogles_(wavelength, laserType, waist, averagePower, impulseEnergy=None, pulseTime=0, pulseRate=0.0, needView=True):
	r = waist / 2
	area = math.pi * r**2
